...
def inference(train_data, test_data, train_tags, test_tags, test_labels, pretrained_model, evaluation = False, out_filename = DIR_PATH+"/results/test_new", topk=3, gmm = None):
